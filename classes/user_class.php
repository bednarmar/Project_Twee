...
class User {
    ...
    /*poniżejprzechowuje informacje o zalogowanej osobie, w przypadku klikniecia
     * przeniesienia sie na inna karte, powodowalo by to wylogowanie tej osoby.
     * Chce zeby byla zalogowana do momentu az sama nie zakonczy sesji.
     */
...
/*    
    $pwdHashed =sha1($pwd);//32 znaki!
dzieki linjice powyzej w $pwdHsed bezpiecznie haslo */
